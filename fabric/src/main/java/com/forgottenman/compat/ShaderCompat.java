...
public final class ShaderCompat {
    ...
    public static boolean stencilAvailable() {
        ...
        // NeoForge patches isStencilEnabled onto RenderTarget; Fabric gets it from
        // RenderTargetMixin through this duck-type interface
        return ((StencilTarget) mc.getMainRenderTarget()).forgottenman$isStencilEnabled()
                && probe(mc);
    }
